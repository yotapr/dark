  ...
  const data2 = offers.map((prop, key) => {
    ...
    return {
      ...
      */
      ...
      materialTotalCost: prop.materialTotalCost,
      ...
      actions: (
        ...
        <div className="text-center">
          ...
          <Button 
            ...
            round="true"
            icon="true"
            onClick={() => dispatch(ApprovedOffer(prop['@id'], true)) }
          >
            APPROVATO
          </Button>
          :
          <Button 
            ...
            round="true"
            icon="true"
            onClick={() => dispatch(ApprovedOffer(prop['@id'], false)) }>
        ...
        <ModalBody>
          <Form onSubmit={(event) => handleSubmit(event)}>
            ...
            <FormGroup>
              ...
              <Input type="number" name="materialTotalCost" id="materialTotalCost" value={materialTotalCost} />
            </FormGroup>
            <FormGroup>
