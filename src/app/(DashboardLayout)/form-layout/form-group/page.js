      ...
      <Row>
        ...
        <Col sm="12" md="6" lg="4">
          <ComponentCard
            ...
            subtitle={
              <p>
                To use add <code>input-group-prepend &amp; append</code> before
                and afetr input field
              </p>
            }
          >
            <Form>
          ...
          >
            <Form>
              <InputGroup>
                <ButtonDropdown
                  isOpen={dropdownOpen}
                  toggle={toggleDropDown.bind(null)}
                >
            ...
            <Form>
              <InputGroup>
                ...
                <ButtonDropdown
                  ...
                  toggle={toggleDropDown1.bind(null)}
                >
                  <DropdownToggle caret>Dropdown</DropdownToggle>
                  <DropdownMenu>
                    <DropdownItem header>Header</DropdownItem>
          ...
          >
            <Form>
              <InputGroup>
                <Input />
                <ButtonDropdown
                  isOpen={splitButtonOpen1}
                  toggle={toggleSplit1.bind(null)}
                >
                  <Button outline>Split Button</Button>
                  <DropdownToggle split outline />
                  <DropdownMenu>
