...
const ContactDetails = () => {
  ...
  const contactDetail = useSelector( (state) => { return { ...state.contactsReducer.contacts[state.contactsReducer.contactContent], startDate: new Date(contactDetail.startDate).getDate() + "/" + (new Date(contactDetail.startDate).getMonth() + 1) + "/" + new Date(contactDetail.startDate).getFullYear() }});
