                    ...
                    <tr>
                      ...
                      <td>
                        <Input
                          ...
                          name="startDate"
                          id="startDate"
                          value={"2024-04-12" //editDate === true ? contactDetailEdit.startDate : new Date(contactDetail.startDate).getFullYear() + "/" + "0" + (new Date(contactDetail.startDate).getMonth() + 1) + "/" + new Date(contactDetail.startDate).getDate()
                          }
