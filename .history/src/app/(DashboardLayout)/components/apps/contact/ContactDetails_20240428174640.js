                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <Button
                        color="primary"
                        onClick={() => { setContactDetailEdit({...contactDetail, id: contactContent, remoteId: contactDetail['@id']}); dispatch(isEdit()) }}
                      >
                        Edit Contact
                      </Button>
                    </td>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <Button
                          color="success"
                          onClick={() => { console.log(contactDetailEdit); dispatch(isEdit())}}
                        >
                          Save Contact
                        </Button>
                      </td>
