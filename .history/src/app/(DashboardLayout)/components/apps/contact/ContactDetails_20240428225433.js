...
const ContactDetails = () => {
  ...
  React.useEffect(() => {
    startDateDefault = useSelector((state) => state.contactsReducer.contacts[state.contactsReducer.contactContent])
    setStartDate(new Date(startDateDefault).getFullYear() + "/" + (new Date(startDateDefault).getMonth() + 1) + "/" + new Date(startDateDefault).getFullYear())
  })
