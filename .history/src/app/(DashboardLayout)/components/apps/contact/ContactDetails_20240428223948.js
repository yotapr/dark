...
const ContactDetails = () => {
  ...
  const [startDate, setStartDate] = React.useState(new Date(state.contactsReducer.contacts[state.contactsReducer.contactContent].startDate).getDate() + "/" + (new Date(state.contactsReducer.contacts[state.contactsReducer.contactContent].startDate).getMonth() + 1) + "/" + new Date(state.contactsReducer.contacts[state.contactsReducer.contactContent].startDate).getFullYear())
