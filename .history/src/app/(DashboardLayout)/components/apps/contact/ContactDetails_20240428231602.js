                    ...
                    <tr>
                      ...
                      <td>
                        <Input
                          ...
                          name="startDate"
                          id="startDate"
                          value={editDate !== true ? contactDetailEdit.startDate : new Date(contactDetail.startDate).getFullYear() + "/" + "0" + (new Date(contactDetail.startDate).getMonth() + 1) + "/" + new Date(contactDetail.startDate).getDate()}
