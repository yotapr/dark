          ...
          <Form onSubmit={(event) => handleSubmit(event)}>
            ...
            <FormGroup>
              ...
              >
                ...
                {categories.map((singleCategory => obj.categoryId !== undefined && singleCategory['@id'] === obj.categoryId ? <option key={singleCategory['@id']} value={singleCategory['@id']} selected>{singleCategory.name}</option> : <option key={singleCategory['@id']} value={singleCategory['@id']}>{singleCategory.name}</option>))}
              </Input>
            </FormGroup>
            <FormGroup>
            ...
            <FormGroup>
              ...
              >
                ...
                {providers.map((singleProvider => singleProvider['@id'] === obj.providerId ? <option selected key={singleProvider['@id']} value={singleProvider['@id']}>{singleProvider.companyName}</option> : <option key={singleProvider['@id']} value={singleProvider['@id']}>{singleProvider.companyName}</option>))}
              </Input>
            </FormGroup>
            <FormGroup>
