          ...
          <Form onSubmit={(event) => handleSubmit(event)}>
            ...
            <FormGroup>
              ...
              >
                ...
                {providers.map((singleProvider => singleProvider['@id'] === obj.providerId ? <option select key={singleProvider['@id']} value={singleProvider['@id']}>{singleProvider.companyName}</option> : <option key={singleProvider['@id']} value={singleProvider['@id']}>{singleProvider.companyName}</option>))}
              </Input>
            </FormGroup>
            <FormGroup>
