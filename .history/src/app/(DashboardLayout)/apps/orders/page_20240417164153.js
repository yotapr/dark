...
import {
  ...
  fetchProviders,
  DeleteProvider,
  toggleStarredProvider,
} from "@/store/apps/contacts/ProviderSlice";
...
const CustomReactTable = () => {
  ...
  const data2 = jsonData.map((prop, key) => {
    return {
      id: key,
      name: prop[0],
      designation: clients.find((singleProvider) => singleProvider['@id'] === prop[11]) && clients.find((singleProvider) => singleProvider['@id'] === prop[11]).companyName,
