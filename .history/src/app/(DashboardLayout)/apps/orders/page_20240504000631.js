...
const CustomReactTable = () => {
  ...
  const data2 = orders.map((prop, key) => {
    return {
      ...
      orderDate: new Date(prop.orderDate).getFullYear() + "-" + (new Date(prop.orderDate).getMonth() + 1) + "-" + new Date(prop.orderDate).getDate(),
      deliveryDate:  new Date(prop.deliveryDate).getFullYear() + "-" + (new Date(prop.deliveryDate).getMonth() + 1) + "-" + new Date(prop.deliveryDate).getDate(),
      realDeliveryDate:  new Date(prop.realDeliveryDate).getFullYear() + "-" + (new Date(prop.orderDate).getMonth() + 1) + "-" + new Date(prop.orderDate).getDate(),
      color: prop.color,
      note: prop.note,
