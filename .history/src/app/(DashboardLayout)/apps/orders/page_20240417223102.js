          ...
          <Form onSubmit={(event) => handleSubmit(event)}>
            ...
            <FormGroup>
              ...
              >
                ...
                {providers.map((singleProvider => obj !== null ? obj.provider === singleProvider['@id'] && <option key={singleProvider['@id']} value={singleProvider['@id']} selected>{singleProvider.companyName}</option> : <option key={singleProvider['@id']} value={singleProvider['@id']}>{singleProvider.companyName}</option>))}
              </Input>
            </FormGroup>
            <FormGroup>
