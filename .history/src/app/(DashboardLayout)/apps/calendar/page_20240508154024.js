...
import { fetchAppointments, addNewAppointment } from "@/store/apps/appointments/AppointmentSlice";
...
const CalendarApp = () => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(addNewAppointment({title: title, appointmentStart: slot.start, appointmentEnd: slot.end, user: "/api/users/1"}))
