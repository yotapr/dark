...
import { fetchAppointments, addNewAppointment, fetchUsers, editAppointment, removeAppointment } from "@/store/apps/appointments/AppointmentSlice";
  ...
  return (
    <>
      <Modal isOpen={modalDelete} toggle={() => setModalDelete(!modalDelete)}>
        ...
        <ModalBody>
          <Button style={{margin: "5px"}} color="danger" onClick={() => {console.log(update); deleteHandler(update);  setModalDelete(!modalDelete)}}>       Rimuovi
          </Button>
          <Button
            color="secondary"
            className="ml-1"
