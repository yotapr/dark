...
import { fetchSalesAgents, deleteOfferItem } from "@/store/apps/salesAgents/SalesAgentsSlice";
  ...
  return (
    <div>
      ...
      <Modal isOpen={modalDelete} toggle={() => setModalDelete(!modalDelete)}>
        ...
        <ModalBody>
          <Button color="danger" onClick={() => {console.log(obj.remoteId); dispatch(deleteOfferItem(obj.remoteId)); setModalDelete(!modalDelete)}}>
            Rimuovi
          </Button>
          <Button
            color="secondary"
