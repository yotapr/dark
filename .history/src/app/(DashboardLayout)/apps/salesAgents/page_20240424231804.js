...
const CustomReactTable = () => {
  ...
  const currentPage = useSelector((state) => state.salesAgentsReducer.currentPage);
  const prevPage = useSelector((state) => state.salesAgentsReducer.prevPage);
  const nextPage = useSelector((state) => state.salesAgentsReducer.nextPage);
    ...
    <div>
      ...
      <ComponentCard title="Action Table">
        <ReactTable
          ...
          onFetchData={async () => {
            setLoading(true)
            await dispatch(fetchSalesAgents());
            setLoading(false)
          }}
        />
      </ComponentCard>
