...
const CustomReactTable = () => {
  ...
  const clients = useSelector((state) => {
    arrayClients = state.contactsReducer.contacts
    let options = []
    options = arrayClients.map((singleClient) => { const newObj = {value: singleClient['@id'], label: singleClient.companyName}; return newObj; })
  });
