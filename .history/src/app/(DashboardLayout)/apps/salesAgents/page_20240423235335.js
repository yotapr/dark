...
import { addSalesAgent, fetchSalesAgents, UpdateSalesAgents, deleteSalesAgentsItem } from "@/store/apps/salesAgents/SalesAgentsSlice";
...
const CustomReactTable = () => {
  ...
  return (
    <div>
      <BreadCrumbs />
      <Modal isOpen={modalDelete} toggle={toggle.bind(null)}>
        <ModalHeader toggle={toggle.bind(null)}>Confermi di voler cancellare?</ModalHeader>
        <ModalBody>
          <Button color="danger" onClick={dispatch(deleteSalesAgentsItem(obj.remoteId))}>
            Rimuovi
          </Button>
          <Button
            color="secondary"
      ...
      </Modal><Modal isOpen={modal} toggle={toggle.bind(null)}>
