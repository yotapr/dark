...
export const UpdateProduct = (payload) => async (dispatch) => {
  try {
    ...
    dispatch(SetProduct(addProduct(payload.productId,payload.name,payload.category,payload.description,payload.stockQuantity,payload.lowLevel,payload.availableQuantity,payload.allocatedQuantity,payload.restockDate,payload.lastRestockQuantity,payload.purchasePrice,payload.sellPrice,payload.weight,payload.dimension,payload.provider,payload.note,payload.remoteId)));
  } catch (err) {
    throw new Error(err);
  }
};
