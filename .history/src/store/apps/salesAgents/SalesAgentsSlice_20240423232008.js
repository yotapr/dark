...
export const UpdateSalesAgents = (id) => async (dispatch) => {
  console.log(payload)  
  try {
...
export const fetchSalesAgents = (id) => async (dispatch) => {
  try {
    const response = await axios.delete('http://awtapi.softwarehouseparma.net/api/sales_agentss');
...
export const deleteSalesAgentsItem = () => async (dispatch) => {
  try {
    const response = await axios.delete('http://awtapi.softwarehouseparma.net/api/sales_agentss');
    dispatch(getSalesAgents(response.data['hydra:member']));
  } catch (err) {
